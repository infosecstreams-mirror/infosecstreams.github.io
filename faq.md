...
If you have a new streamer to add or spot an error, please let us know! As an alternative method to opening a pull request, we are currently working on a more frictionless onboarding process and will update this section soon.

## Who maintains the InfoSec Streams list?

The project was started by [chadb_n00b](https://twitch.tv/chadb_n00b) and is currently maintained by DiscoMouse. [DiscoMouse](https://github.com/DiscoMouse) currently maintains all the golang code in [secinfo](https://github.com/infosecstreams-mirror/secinfo), [streamstatus](https://github.com/infosecstreams-mirror/streamstatus), and [this](https://github.com/infosecstreams-mirror/infosecstreams-mirror.github.io) repository.
